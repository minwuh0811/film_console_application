                ...
                case (1):
                    ...
                    switch (admin_choice) {
                        case (1):
                            ...
                            Administrator.setID(administratorStorageBin.getAdministratorlist().size());
                            ...
                            if (login(administratorStorageBin.getAdministratorlist(), loginName, password)) {
                                ...
                                switch (loginChoice) {
                                    case (1):
                                        ...
                                        film.setID(filmStorageBin.getFilmlist().size());
                                        ...
                                        ticket.setID(ticketStorageBin.getTicketlist().size());
